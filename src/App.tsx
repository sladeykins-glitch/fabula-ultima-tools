...
import { aestraNations, aestraOrigins, applyAestraMonsterIdentity, aestraGenerationHint, refreshAestraAffinities, refreshAestraMonsterLabel, AestraInfluence, AestraNation, AestraOrigin, valdoriaDepths, ValdoriaDepth } from './aestra'
